...
import BillveryContainer from './billvery.container'
import BilldeliveryContainer from './billdelivery.container'
    ...
    return (
      <Router>
        <Switch>
          ...
          <Route exact path="/billverymanager" component={BillveryContainer} />
          <Route exact path="/billdeliverymanager" component={BilldeliveryContainer} />
        </Switch>
      </Router>
    );
  }
