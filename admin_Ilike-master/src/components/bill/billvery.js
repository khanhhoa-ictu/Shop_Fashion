...
class Billvery extends Component {
  constructor() {
    super();
    this.state = {
      pagination: [],
  ...
  render() {
    ...
    this.props.bill.map((element,index)=>{
      ...
      if(element.issend ==='1'){
        return(
          xhtmlsend =  <select onChange={e => this.props.updateIssend(e.target.value,element._id)}>
           
          <option value='99' selected>Đang Chờ Xử Lý</option>
