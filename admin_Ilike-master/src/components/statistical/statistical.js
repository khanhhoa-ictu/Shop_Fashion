        ...
        <section class="wrapper">
            ...
            <div className="col-lg-12">
              <section className="panel">
                <header className="panel-heading row">
                  <h4 className='col-sm-3'>THỐNG KÊ THEO NGÀY</h4> 
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th>Số Sản Phẩm Được Mua</th>
                        <th>Số Người Mua Hàng</th>
                        <th>Tổng Thu Nhập</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <div className="row">
            <div className="col-lg-12">
              <section className="panel">
                <header className="panel-heading row">
                  <h4 className='col-sm-3'> THỐNG KÊ THEO THÁNG</h4>
                 <div className='col-sm-9'>
          ...
          <div className="row">
            <div className="col-lg-12">
              <section className="panel">
                <header className="panel-heading row">
                  <h4 className='col-sm-3'>THỐNG KÊ THEO NĂM</h4>
                  <div className='col-sm-9'>
