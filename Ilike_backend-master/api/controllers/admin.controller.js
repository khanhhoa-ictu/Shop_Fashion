...
exports.addProduct = async (req, res) => {
    ...
    const {category, sizes, name, price, release_date, describe, id_category} = req.body;
...
exports.updateProduct = async (req, res) => {
    ...
    let { name, id_category, price, release_date, describe,id,category, sizes } = req.body;
...
exports.getAllUser = async(req, res) => {
    ...
    let totalPage = parseInt(((count - 1) / 8) + 1);
    let { page } = req.params;
